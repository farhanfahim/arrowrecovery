...
/**
 */
class OrderDetailShimmerAdapter(private val activity: Context, private val arrData: List<Order>, private val onItemClick: OnItemClickListener) : PagingAdapter() {
    ...
    private fun setListener(holder: ViewHolder, model: Order?) {
        holder.layoutItemMyOrder!!.setOnClickListener { onItemClick.onItemClick(holder.adapterPosition, model, it, OrderDetailShimmerAdapter::class.java.simpleName) }
        }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindTo(model: Order?, context: Context,position :Int) {
            ...
            this.model?.let {
                ...
                txtRef!!.text = it!!.orderProducts[position].product.serial_number
